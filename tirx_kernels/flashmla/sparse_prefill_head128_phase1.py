    ...
    if warp_idx == 0:
        if T.ptx.elect_sync():
            ...
            for init_stage in T.unroll(NUM_BUFS):
                T.ptxd.mbarrier.init.shared.b64(bar_qk_part_done.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_qk_done.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_sv_part_done.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_sv_done.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_k_part0_ready.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_k_part1_ready.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_v_part0_ready.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_v_part1_ready.ptr_to([init_stage]), T.uint32(1))
                T.ptxd.mbarrier.init.shared.b64(bar_p_free.ptr_to([init_stage]), T.uint32(128 * 2))
